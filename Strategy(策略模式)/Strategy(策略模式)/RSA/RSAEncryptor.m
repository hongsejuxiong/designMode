...
- (NSData *)encryptionString:(NSString *)string {
    ...
    NSData *dataSource = [string dataUsingEncoding:NSUTF8StringEncoding];

    return [self rsaEncryptData:dataSource];
}
...
-(NSString*) rsaEncryptString:(NSString*)string {
    ...
    NSString* base64EncryptedString = [Base64 encodeBase64Data:encryptedData];
